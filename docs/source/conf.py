...
myst_html_meta = {
    "description": "IP2Proxy OCaml module allows users to query an IP address to determine if it was being used as open proxy, web proxy, VPN anonymizer and TOR exits.",
    "keywords": "IP2Proxy, Proxy, IP location, OCaml",
...
html_title = "IP2Proxy OCaml"

# html_baseurl = "https://ip2proxy-ocaml.readthedocs.io/en/latest/"